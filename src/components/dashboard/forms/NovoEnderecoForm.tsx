...
function OriginalNovoEnderecoForm() {
  ...
  }, [rua, numero, bairro, cidade, cep, complemento, referencia, clienteNome, router, toast]);
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-1">
              ...
              <Input id="clienteNome" value={clienteNome} onChange={(e) => setClienteNome(e.target.value)} placeholder="Nome do cliente para este endereço" disabled={isLoading}/>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                <Label htmlFor="rua">Rua / Avenida <span className="text-destructive">*</span></Label>
                <Input id="rua" value={rua} onChange={(e) => setRua(e.target.value)} placeholder="Ex: Rua das Palmeiras" required disabled={isLoading}/>
              </div>
              <div className="space-y-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <Input id="bairro" value={bairro} onChange={(e) => setBairro(e.target.value)} placeholder="Ex: Centro" required disabled={isLoading}/>
              </div>
              <div className="space-y-1">
                <Label htmlFor="cep">CEP <span className="text-destructive">*</span></Label>
                <Input id="cep" value={cep} onChange={(e) => setCep(e.target.value)} placeholder="Ex: 12345-678" required disabled={isLoading}/>
              </div>
            </div>
             <div className="space-y-1">
                <Label htmlFor="cidade">Cidade <span className="text-destructive">*</span></Label>
                <Input id="cidade" value={cidade} onChange={(e) => setCidade(e.target.value)} placeholder="Ex: Cidade Exemplo" required disabled={isLoading}/>
            </div>
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <Textarea id="referencia" value={referencia} onChange={(e) => setReferencia(e.target.value)} placeholder="Ex: Próximo ao mercado, em frente à praça" rows={2} disabled={isLoading}/>
            </div>
          </CardContent>
...
const NovoEnderecoForm = React.memo(OriginalNovoEnderecoForm);
