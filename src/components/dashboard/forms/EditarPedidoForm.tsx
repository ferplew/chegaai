...
function OriginalEditarPedidoForm({ pedidoId }: EditarPedidoFormProps) {
  ...
  const handleSelectChange = useCallback((name: keyof PedidoFormData, value: string) => {
  ...
  }, [formData, pedidoId, router, toast]);
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.formaPagamento} onValueChange={(value) => handleSelectChange('formaPagamento', value)} name="formaPagamento" required disabled={isLoading}>
                 ...
                 <div className="space-y-2">
                  ...
                  <Select value={formData.status} onValueChange={(value) => handleSelectChange('status', value as PedidoFormData['status'])} name="status" required disabled={isLoading}>
...
const EditarPedidoForm = React.memo(OriginalEditarPedidoForm);
