...
function OriginalNovoClienteForm() {
  ...
  }, [nome, email, telefone, rua, numero, bairro, cidade, cep, complemento, referencia, toast, router, resetForm]);
...
const NovoClienteForm = React.memo(OriginalNovoClienteForm);
